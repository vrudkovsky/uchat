...
static bool insertRecord(const char *str_1, const char *str_2) {
    char *string_1 = mx_strnew(1000);
    //string_1 = "DELETE FROM user_contacts WHERE user_id = '2' AND contact_id = '5'";


    string_1 = "DELETE FROM user_contacts WHERE user_id = '";
    const char *string_2 = str_1;
    char *string_3 = "' AND contact_id = '";
    const char *string_4 = str_2;
    char *string_5 = "'";
